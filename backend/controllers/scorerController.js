...
module.exports = {  // ✅ สำคัญ: ต้องมี module.exports ตรงนี้
    ...
    async saveMatchEvent(req, res) {
        try {
            ...
            // 💬 ตามที่คุณแจ้ง: เรื่อง skill/grade เกี่ยวกับเจ้าหน้าที่ VIS เท่านั้น
            // โต๊ะบันทึกไม่ได้ใช้ส่วนนี้ในการแสดงผลทางสถิติ จึงส่งค่าเป็น null 
            // เพื่อหลีกเลี่ยง error การเช็คคำศัพท์จาก (skill_enum) ในฐานข้อมูล
            let skill = null;
            let grade = null;
