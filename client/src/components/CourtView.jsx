                    ...
                    <div className="grid grid-cols-2 grid-rows-3 w-full h-full relative">
                        ...
                        <div className="flex items-center justify-center relative">
                            ...
                            {servingSide === 'left' && !hideTokens && (
                                <div className="absolute -left-1 lg:-left-4 text-xl lg:text-3xl animate-bounce drop-shadow-md z-20"><img url="../../assets/img/ball.png"></img></div>
                            )}
                        </div>
                    ...
                    <div className="grid grid-cols-2 grid-rows-3 w-full h-full relative">
                        ...
                        <div className="flex items-center justify-center relative">
                            ...
                            {servingSide === 'right' && !hideTokens && (
                                <div className="absolute -right-1 lg:-right-4 text-xl lg:text-3xl animate-bounce drop-shadow-md z-20"><img url="../../assets/img/ball.png"></img></div>
                            )}
                        </div>
                        {/* Row 2 */}
